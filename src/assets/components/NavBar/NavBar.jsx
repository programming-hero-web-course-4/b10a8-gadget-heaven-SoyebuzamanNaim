  ...
  return (
    <div className={`md:m-4 ${isHomePage ? "bg-purple-500  rounded-t-xl" : "bg-white"}`}>
      ...
      <div className="navbar-end space-x-2">
        <NavLink
          to="dashboard/cart"
          className={({ isActive }) => `btn rounded-full text-xl ${isActive||isDashboard||isCart? "text-purple-900 border-2 font-extrabold  border-purple-500":" border-gray-300"}`}
        >
          <CiShoppingCart />
        </NavLink>
        <NavLink to="dashboard/wishlist" className={({ isActive }) => `btn rounded-full text-xl ${isActive? "text-purple-900 border-2 font-extrabold  border-purple-500":" border-gray-300"}`}>
          <CiHeart />
        </NavLink>
      </div>
      </div>
