    ...
    <>
      ...
      <div>
        <div className="container mx-auto px-4 py-10 ">
          <h2 className="font-bold text-xl mb-6 text-center md:text-left">
            Cart
          </h2>
          ...
          <div className="flex justify-between">
            ...
            <div className="flex flex-col md:flex-row items-center justify-end gap-4">
              <button
                ...
                className="flex items-center gap-1 btn rounded-3xl border border-purple-500 bg-white text-purple-500 px-4 py-2 hover:bg-purple-100"
              >
                Sort by Price <TbSortAscending />
              </button>

              <button
                className="btn rounded-3xl bg-purple-500 text-white px-6 py-2 hover:bg-purple-600 disabled:bg-gray-300 disabled:cursor-not-allowed"
